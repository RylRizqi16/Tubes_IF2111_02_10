...
void main_menu(){
    ...
    printf("11. HISTORY         : Menampilkan riwayat transaksi\n");
    printf("12. WISHLIST ADD    : Menambahkan barang ke wishlist\n");
    printf("13. WISHLIST SWAP   : Menukar barang di wishlist\n");
    printf("14. WISHLIST REMOVE : Menghapus barang dari wishlist\n");
    printf("15. WISHLIST REMOVE INDEX : Menghapus barang dari wishlist berdasarkan indeks\n");
    printf("16. WISHLIST CLEAR  : Menghapus semua barang dari wishlist\n");
    printf("17. WISHLIST SHOW   : Menampilkan barang-barang di wishlist\n");
    printf("18. OPTIMASI RUTE   : Mengoptimalkan rute\n");
    printf("19. PROFILE         : Melihat profil pengguna\n");
    printf("20. LOGOUT          : Keluar dari sesi\n");
    printf("21. SAVE            : Menyimpan state ke dalam file\n");
    printf("22. QUIT            : Keluar dari program\n");
