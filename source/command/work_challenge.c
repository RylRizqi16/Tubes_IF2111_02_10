...
list rwg(){
    char word[400][6] = {"abadi","abang","abjad","absah","absen","acara","acung","adisi","afiks","agama","agami","agung","ajaib","ajang","akbar","akhir",
                        ...
                        "asbak","asbes","asing","aspal","aspek","aster","asyik","ateis","atlas","atlet","audio","avtur","babak","babat","babon","babun",
                        "bacem","bacok","bacot","badai","badak","badan","badui","badut","bagai","bagan","bagus","bahan","bahas","bahwa","bajaj","bajak",
                        "bakal","bakar","bakat","bakau","bakmi","bakso","bakti","bakul","balad","balet","balig","balik","balok","balon","balut","bambu",
                        "banci","bando","bantu","bapak","barak","barat","barel","baret","baris","baron","basah","basil","basis","basmi","basuh","batas",
                        "batik","batin","batok","batuk","bawah","bawel","bayam","bayar","bayam","bazar","bebal","beban","bebas","bebek","beber","becak",
                        "becek","becus","bedah","bedak","beduk","begah","begal","bejat","bekal","bekas","belah","belai","belas","belek","belia","belok",
                        "belot","beluk","belum","belut","benah","benak","benam","benar","benci","benda","benih","benua","berai","beras","berat","beres",
                        "besar","beset","besit","besok","besuk","betah","betis","beton","betul","biang","biara","biasa","biaya","bibir","bibit","bidah",
                        "bidak","bidan","bidet","bidik","biduk","bihun","bijak","bijih","bikin","biksu","bilah","bilas","bilik","bilur","binar","biner",
                        "biola","biota","birit","bisik","bison","bisul","blong","blues","bobol","bodoh","bogor","bokek","bolak","boleh","bolos","bonus",
                        "borok","boros","bosan","botak","botol","bruto","buang","buaya","bubar","bubuh","bubuk","bubur","budak","budek","bufer","bufet",
                        "bugar","bugil","bujuk","bujur","bukan","bukau","buket","bukit","bukti","bulai","bulan","bulat","bulir","buluh","buluk","bulus",
                        "bumbu","bunda","bunga","buntu","bunuh","bunyi","buram","burik","buron","bursa","buruh","buruk","buset","busuk","busur","butek",
                        "butik","butir","butuh","butut","buyar","buyur","buyut","cabai","cabik","cabut","cacah","cacar","cacat","cadar","cadas","cadel",
                        "cagar","cakap","cakar","cakep","cakra","cakup","calon","camar","camat","canai","canda","candi","candu","capai","capit","carik",
                        "catat","catur","cawan","ceban","cebol","cebur","cecah","cecak","cecer","cedok","cegah","ceguk","cekam","cekek","ceker","celah",
                        "celik","celup","cemar","cemas","cepak","capat","ceper","cerah","cerai","cerca","ceria","cerna","cetak","cetek","cewek","cibir",
                        "cicil","cicip","cicit","ciduk","cikal","cilik","cilok","cinta","cipta","citra","cobek","cocok","cocol","codet","colek","colok",
                        "comel","comot","copet","copot","corak","coret","cowok","cuaca","cubit","cucuk","cukai","cukup","cukur","culik","culun","cuman",
                        "curah","dadar","dadih","dahak","dahan","dajal","dakar","dakwa","dalam","dalih","dalil","damai","damba","danau","dansa","dapat"};
    list selected_word;
    int idx = rng() % 400;
    for(int i=0;i<5;i++){
